...
2. **Search conversations** (skills/collaboration/vault-remembering-conversations)
...
2. **Conversation history** (search with skills/collaboration/vault-remembering-conversations)
