...
**Examples:**
- User skills: `~/.claude/skills/maintaining-book-notes/SKILL.md`, `~/.claude/skills/context-aware-reasoning/SKILL.md`
- Plugin skills: `superpowers:test-driven-development`, `superpowers:systematic-debugging`
